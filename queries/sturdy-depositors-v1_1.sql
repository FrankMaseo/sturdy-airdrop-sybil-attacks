...
Description:
  Preparing dataset to ingest by processing script. Consists of all sturdy depositors with 1st deposit date, wallet creation date and wallet funding address.
*/
